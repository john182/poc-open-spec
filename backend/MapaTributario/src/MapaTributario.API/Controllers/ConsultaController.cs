...
/// Requer autenticacao (qualquer usuario logado).
/// </summary>
[ApiController]
[Route("api/v1")]
[Authorize]
public class ConsultaController : ControllerBase
{
    ...
    /// <summary>
    /// Lista municipios de um estado com status de processamento.
    /// </summary>
    /// <param name="uf">Sigla da UF (ex: SP, RJ, MG).</param>
    /// <returns>Status de processamento e lista de municipios com aliquotas.</returns>
    /// <response code="200">Resposta com status de processamento e municipios.</response>
    /// <response code="404">UF nao encontrada.</response>
    [HttpGet("estados/{uf}/municipios")]
    [ProducesResponseType(typeof(MunicipiosUfResponse), StatusCodes.Status200OK)]
